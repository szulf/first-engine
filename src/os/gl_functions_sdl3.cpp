...
void setup_gl_functions()
{
  ...
  LOAD_SDL_GL_PROC(PFNGLGENRENDERBUFFERSPROC, glGenRenderbuffers);
  LOAD_SDL_GL_PROC(PFNGLBINDRENDERBUFFERPROC, glBindRenderbuffer);
  LOAD_SDL_GL_PROC(PFNGLRENDERBUFFERSTORAGEPROC, glRenderbufferStorage);
  LOAD_SDL_GL_PROC(PFNGLFRAMEBUFFERRENDERBUFFERPROC, glFramebufferRenderbuffer);
}
